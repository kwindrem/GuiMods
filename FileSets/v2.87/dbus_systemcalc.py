...
#### modified for GuiMods -- added Alternator, Wind generator (DC Meter subtype Wind Generator (-8))
...
#### temporary add for GuiMods - added by Victron in v2.90
