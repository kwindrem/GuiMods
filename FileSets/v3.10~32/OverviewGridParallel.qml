...
////// GuiMods — DarkMode
	...
	OverviewBox {
		...
		width: 148
		height: 100
		title: sys.remoteGeneratorSelected.value === 1 ? getAcSourceName(2) : getAcSourceName(sys.acSource)
////// GuiMods — DarkMode
		...
		MbIcon {
			iconId: sys.remoteGeneratorSelected.value === 1 ? getAcSourceIcon(2) : getAcSourceIcon(sys.acSource)
			anchors {
